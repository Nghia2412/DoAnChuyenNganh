    ...
    <div class="clearfix"></div>
                        ...
                        <?php
                         foreach($data as $r)
                         {
                           ...
                           <div class="col-md-3 col-sm-6">
                                <div class="products">
                                 <div class="thumbnail"><a href="index.php?controller=sanpham&action=sua&id=<?php echo $r['id_dianhac']?>"><img src="../admin/views/assets/img/<?php echo $r['hinh'] ?> " alt="Product Name" ></a></div>
                                 <div class="productname"><?php echo $r['tendianhac'] ?></div>
                                 <h4 class="price"><?php echo $r['gia'] ?>.VNĐ</h4>
                                
                                 <div class="button_group">
                                     <button class="button add-cart"><a href="index.php?controller=sanpham&action=sua&id=<?php echo $r['id_dianhac']?>">Xem chi tiết</a></button>
                                     <button class="button compare" ><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
      ...
      <div class="single-widget-area mb-30">
                            ...
                            <div class="widget-content">
                                <ul class="tags">
                                <?php foreach($datadm as $arr)
                                        {
                                        ?>
                                            <li><a href="index.php?controller=sanpham&action=hientheloai&id=<?php echo $arr['id_theloai']?>"><?php echo $arr['tentheloai']?></a></li>  
                                        <?php 
                                        }
                                        ?>
                                </ul>
